...
from daedalus.agents.coding_agent import coding_agent, create_coding_agent
from daedalus.project import project
from daedalus.tools.mcp import load_mcp_tools
...
class ConsoleApp(App):
    ...
    async def _init_agent(self) -> None:
        ...
        try:
            ...
            terminal_view.write(f"- Failed to load MCP tools: {e}\n", True)
            return
        ...
        async for chunk in self._coding_agent.astream(
            ...
            for role in roles:
                ...
                if not isinstance(update, dict):
                    continue
                messages: list[AnyMessage] = update.get("messages", [])
